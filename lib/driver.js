...
class EspressoDriver extends BaseDriver {
  ...
  async startEspressoSession () {
    ...
    if (this.caps.appActivity) {
      this.caps.appActivity = qualifyActivityName(this.caps.appActivity);
    } else {
      this.caps.appActivity = qualifyActivityName(appInfo.appActivity);
    }
    if (this.caps.appWaitActivity) {
      this.caps.appWaitActivity = qualifyActivityName(this.caps.appWaitActivity);
    } else {
      this.caps.appWaitActivity = qualifyActivityName(appInfo.appWaitActivity);
    }
