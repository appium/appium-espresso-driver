  ...
  async createSession (...args) {
    try {
      ...
      if (this.isChromeSession) {
        logger.errorAndThrow(`Chrome browser cannot be run in Espresso sessions because Espresso automation doesn't have permission to access Chrome. Use UiAutomator2 instead`);
      }
