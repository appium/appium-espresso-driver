...
commands.updateSettings = async function (_settings) {
  // Espresso has not had settings yet
};

// eslint-disable-next-line require-await
commands.getSettings = async function () {
  // we might have some driver-only settings to return as well
  const driverOnlySettings = {};
