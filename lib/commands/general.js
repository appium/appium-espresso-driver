 ...
 *
 *
 * @throws  will throw error if target is not 'activity' or 'application'
 * @throws  will throw error if a method is not found with given argument types
 *
 * @return will return execution results of method as string. If method return type is void, "<VOID>" will be returned
 *
 */
