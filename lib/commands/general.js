...
commands.mobileRequestPermissions = async function (opts = {}) {
  ...
  return await this.espresso.jwproxy.command('/appium/execute_mobile/request_permissions', 'POST', {permissions});
};
