...
class ServerBuilder {
  ...
  getCommand () {
    ...
    let buildProperty = function (key, value) {
    ...
    if (this.signingConfig) {
      args.push(
        buildProperty('appiumZipAlign', this.signingConfig.zipAlign),
        buildProperty('appiumKeystoreFile', this.signingConfig.keystoreFile),
        buildProperty('appiumKeystorePassword', this.signingConfig.keystorePassword),
        buildProperty('appiumKeyAlias', this.signingConfig.keyAlias),
        buildProperty('appiumKeyPassword', this.signingConfig.keyPassword)
      );
    }
